	...
	iframe.src  = chrome.extension.getURL ("testsears.html");
...
//yourDIV.appendChild(iframe);
    ...
    var link='http://65.111.164.36/valueTag/appWebService/getcoupon.php?store=sears';
var dispar=[];
  ...
  var x;var lstr='';
    ...
    var mytb=document.body.querySelectorAll('#coupons')[0];
...
document.body.insertBefore(mya, document.body.firstChild);
...
//document.body.appendChild('<a href="#openModal">View Coupons! </a><div id="openModal" class="modalDialog"><div><a href="#close" title="Close" class="close">X</a><h2>Coupon Page</h2><div id="hello"> This page Displays coupons.</div></div></div>');
  var count=0,money=[],max=0,ff=0;
   ...
   function apply(dispar,n)
    {
      var ip=document.getElementById('couponCode');
      var bc=document.getElementById("apply-coupon");
