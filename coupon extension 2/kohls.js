	...
	iframe.src  = chrome.extension.getURL ("kohls.html");
...
//yourDIV.appendChild(iframe);
    ...
    var t = document.createTextNode("this is the online marketing store where button apllicable! ");
    btn.appendChild(t);
    //Appending to DOM 
    document.body.appendChild(btn);
    document.body.insertBefore(btn, document.body.firstChild);

    var link='http://65.111.164.36/valueTag/appWebService/getcoupon.php?store=kohls';
var dispar=[];
  ...
  var x;var lstr='';
   ...
   // mydiv.appendChild(myimg);
    ...
    var mytb=document.getElementById("apply_code_input");
    

     var ip=document.getElementById("apply_code_input");
    // ip.autocomplete="on";
    // ip.value="";
...
//document.body.appendChild('<a href="#openModal">View Coupons! </a><div id="openModal" class="modalDialog"><div><a href="#close" title="Close" class="close">X</a><h2>Coupon Page</h2><div id="hello"> This page Displays coupons.</div></div></div>');
  ...
  var initial=parseFloat(document.body.querySelectorAll('.summaryValue')[7].textContent.split('$')[1]);
   ...
   function apply(dispar,n)
    {
      var ip=document.getElementById('apply_code_input');
      var bc=document.getElementById("applyCodeButton");
